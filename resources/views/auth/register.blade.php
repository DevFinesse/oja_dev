                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_location" type="text" class="form-control{{ $errors->has('user_location') ? ' is-invalid' : '' }}" name="user_location" value="{{ old('user_location') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="gender" required="" id="gender" class="form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}">
